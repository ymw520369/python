...
javaSourceTemplate = """
 ...
 import org.zhmj.zlzy.core.Sample;
 import org.zhmj.zlzy.core.SampleFactory;
 import org.zhmj.zlzy.core.SampleFactoryImpl;
...
class JavaSourceTemplate:
    ...
    def genJavaSource(self):
        ...
        return javaSourceTemplate % (
            self.package, time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), self.className, self.className,
            strFields)
